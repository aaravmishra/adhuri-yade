...
<div class="col-lg-10">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <form method="post" action="<?php echo site_url();?>add_quots">
            <?php echo validation_errors();?>
                <div class="form-group"><label for="company" class=" form-control-label">Tittle</label>
                    <input type="text" name="tittle" id="company" placeholder="Tittle" class="form-control"></div>
                        <textarea id="mytextarea" name="quots">
                        </textarea><br>
                    <button type="submit " name="submit" class="btn btn-primary" style="margin-left:300px;">Add Quots</button>
            </form>
