    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url();?>dashboard"><img src="<?php echo site_url();?>assets/images/ADHURI_YADE-LOGOFINAL1.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="<?php echo site_url();?>dashboard"><img src="<?php echo site_url();?>assets/images/ADHURI_YADE-LOGOFINAL1.png" alt="Logo"></a>
            </div>
